...
<link rel="stylesheet" href="http://localhost:8080/jsp2/static/css/signUp.css">
	...
	<div id="wrap">
		...
		<form method="post" action="signUpSave.jsp">
			...
			<div id="formData">
				...
				<div class="inputField">
					<input type="password" id="password" class="pwChk" name="password">
					<label for="password">비밀번호</label>	
				</div>
				<div class="inputField">
					<input type="password" id="chk" class="pwChk" name="password">
